		...
		>
			...
			>
				...
				<div className="text-sm text-void-fg-3 mb-4">
					{type === 'default' ? `${modelName} comes packaged with Devonz, so you shouldn't need to change these settings.`
						: isUnrecognizedModel
							? `Model not recognized by Devonz.`
							: `Devonz recognizes ${modelName} ("${recognizedModelName}").`}
				</div>
							...
							<div className={`${shouldShowTab('general') ? `` : 'hidden'} flex flex-col gap-12`}>
								...
								<div>
									<ErrorBoundary>
										...
										<h4 className='text-void-fg-3 mb-4'>{`Transfer your editor settings into Devonz.`}</h4>
